...
This was run on underwhelming (2017 edition) hardware; the relative performance of the underlying tools is the
...
## Further documentation
  ...
  * See [BUGS.md](docs/BUGS.md) for known issues and contract inconsistencies that are tracked for future fixes.
